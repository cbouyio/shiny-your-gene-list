...
header <- dashboardHeader(
  title = "Shiny your gene list project"
)
...
server <- function(input, output, session) {
  ...
  geneList = reactive({
    if(is.null(input$file)){
      ...
      print("Now choose your enrichment in the sidebar")
      print(df)
  ...
  #   if(is.null(input$manualEntry)){
  #     print("Write an ordered or unordered list of genes")
  #   } else {
  #     req(input$manualEntry) #check if something is written before opening it
  #     df <- read.csv(text=input$manualEntry,header=FALSE)
  #     print("Now choose your enrichment in the sidebar")
  ...
  #Check the switch button below every barplot of GOenrichment
  # if (input$switchMF == TRUE | input$switchBP == TRUE | input$switchCC == TRUE ){
  #   output$plotGO = 
  # }
